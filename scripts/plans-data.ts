...
export const PLANS: PlanSeed[] = [
  ...
  },
  {
    ...
    sortOrder: 5,
    days: [
      { label: "An invitation to bring it", book: "Philippians", chapter: 4, devotional: "Paul writes this letter from prison, yet tells a worried church: don’t be anxious about anything, but present every request to God, and let peace guard your hearts.", reflection: "Name one specific anxious thought and try turning it into an actual request, out loud or in writing." },
      { label: "Birds and flowers", book: "Matthew", chapter: 6, devotional: "Jesus points to birds fed without farming and flowers clothed without weaving, then asks: won’t your Father do at least as much for you?", reflection: "What worry are you carrying today that you could consciously hand over, even just for today?" },
      { label: "A fixed point", book: "Psalms", chapter: 46, devotional: "Written for people facing real upheaval — mountains falling into the sea — this psalm doesn’t deny the chaos, it insists on a fixed point within it: God is our refuge and strength.", reflection: "What’s shaking in your life right now that you need a fixed point for?" },
      { label: "Casting it on him", book: "1 Peter", chapter: 5, devotional: "Peter’s instruction is almost physical: cast all your anxiety on him, because he cares for you. Not manage it alone, not suppress it — cast it, hand it off.", reflection: "What would it actually look like, today, to hand this off rather than carry it alone?" },
      { label: "A different peace", book: "John", chapter: 14, devotional: "Facing his own arrest and death, Jesus tells his closest friends: let not your hearts be troubled, my peace I give you, not as the world gives.", reflection: "What’s the difference, for you, between the peace the world offers and the peace this verse describes?" },
    ],
  },
  {
    id: "grief",
    ...
    sortOrder: 6,
    days: [
      { label: "Close to the brokenhearted", book: "Psalms", chapter: 34, devotional: "Tradition connects this psalm to one of David’s lowest moments, and still it insists: the LORD is close to the brokenhearted, and saves those who are crushed in spirit.", reflection: "Where do you feel brokenhearted today, and can you imagine God as close rather than distant from it?" },
      { label: "Jesus weeps", book: "John", chapter: 11, devotional: "Jesus weeps at his friend Lazarus’s tomb, even knowing he’s about to raise him. Grief isn’t skipped, even when hope is coming.", reflection: "Give yourself permission today to feel the loss fully, without rushing to the hopeful part." },
      { label: "New every morning", book: "Lamentations", chapter: 3, devotional: "In the middle of five poems mourning a destroyed city, one verse turns unexpectedly toward hope: his mercies are new every morning; great is your faithfulness.", reflection: "What would it mean to expect mercy new tomorrow morning, even in the middle of grief today?" },
      { label: "Rod and staff", book: "Psalms", chapter: 23, devotional: "Even walking through the valley of the shadow of death, the psalmist doesn’t walk alone — a presence goes with him, rod and staff for comfort.", reflection: "Who or what has been your “rod and staff” — the thing that’s comforted you — in this loss?" },
      { label: "Every tear", book: "Revelation", chapter: 21, devotional: "The story’s ending isn’t escape from sorrow but God himself, present, wiping away every tear — grief taken seriously enough to be personally addressed.", reflection: "What would it mean to you for your own grief to be seen and personally addressed, not just resolved in general?" },
    ],
  },
  {
    id: "doubt",
    ...
    days: [
      ...
      { label: "Longing like a deer", book: "Psalms", chapter: 42, devotional: "The psalmist is remarkably honest about spiritual dryness — his soul downcast, longing for God like a deer panting for water it can’t find.", reflection: "Is there a season of spiritual dryness you’ve been afraid to admit, even to yourself?" },
      { label: "How long?", book: "Habakkuk", chapter: 1, devotional: "Habakkuk opens his short book by arguing with God directly — how long will you let injustice go unanswered? Scripture makes room for this kind of question, not just tidy answers.", reflection: "What’s the question you’ve been afraid was too irreverent to actually ask God?" },
      { label: "Ask for wisdom", book: "James", chapter: 1, devotional: "James writes to a scattered, struggling community that wisdom is available simply by asking — and that even in trials, something is being built, if we let the process do its work.", reflection: "What if the doubting itself were part of the process, not a failure of it?" },
    ],
  },
  {
    id: "forgiveness",
    ...
    days: [
      ...
      { label: "Before the sun goes down", book: "Ephesians", chapter: 4, devotional: "Paul pairs a striking command — don’t let the sun go down on your anger — with tenderness and forgiveness as the actual alternative to bitterness.", reflection: "Is there anger you’ve been carrying past its useful life? What would it take to set it down today?" },
    ],
  },
  {
    id: "gratitude",
    ...
    sortOrder: 9,
    days: [
      { label: "Enter with thanksgiving", book: "Psalms", chapter: 100, devotional: "A short psalm of pure thanksgiving: enter his gates with thanksgiving, his courts with praise — gratitude as the doorway into worship, not an afterthought to it.", reflection: "Name three specific things — not general categories — you’re grateful for today." },
      { label: "In all circumstances", book: "1 Thessalonians", chapter: 5, devotional: "Paul’s instruction is deceptively simple and hard: give thanks in all circumstances. Not for every circumstance, but within them.", reflection: "What’s one hard circumstance right now where you could still find something to be thankful within?" },
      { label: "The one who came back", book: "Luke", chapter: 17, devotional: "Ten men with leprosy are healed, and only one — a Samaritan, an outsider — comes back to say thank you. Jesus notices the nine who didn’t.", reflection: "Is there a good thing in your life you’ve stopped noticing because it became familiar?" },
      { label: "The secret of contentment", book: "Philippians", chapter: 4, devotional: "Paul, writing from prison, says he’s learned the secret of contentment in any and every situation — a learned skill, not a natural gift.", reflection: "What would it mean for contentment to be something you practice, rather than something you’re waiting to feel?" },
      { label: "Do not forget", book: "Psalms", chapter: 103, devotional: "David lists specific things not to forget — forgiveness, healing, redemption, love, satisfaction — preaching gratitude to his own soul like a discipline.", reflection: "What’s on your own list of things not to forget, the next time you feel discouraged?" },
    ],
  },
  {
    id: "waiting",
    ...
    sortOrder: 10,
    days: [
      { label: "Wait for the Lord", book: "Psalms", chapter: 27, devotional: "David, naming real fear and real enemies, ends with an instruction to himself: wait for the LORD; be strong and take heart, and wait for the LORD.", reflection: "What are you waiting for right now, and what would it mean to wait with strength rather than just enduring?" },
      { label: "A promise decades in the making", book: "Genesis", chapter: 12, devotional: "God’s promise to Abram — land, descendants, blessing — would take decades to even begin fulfilling, and Abram never saw its full completion in his lifetime.", reflection: "What promise are you holding that might outlast your own timeline for it?" },
      { label: "Renewed strength", book: "Isaiah", chapter: 40, devotional: "Those who wait for the LORD will renew their strength, soar like eagles, run and not grow weary — waiting reframed not as passive delay but as a source of strength.", reflection: "How might your current waiting be building something in you, even if you can’t see it yet?" },
      { label: "Wait quietly", book: "Lamentations", chapter: 3, devotional: "In the middle of grief over a destroyed city, the writer concludes: it is good to wait quietly for the salvation of the LORD.", reflection: "What would “waiting quietly” — without frantic control — look like for you this week?" },
      { label: "Groaning in hope", book: "Romans", chapter: 8, devotional: "Paul describes creation itself as waiting, groaning, in eager expectation — waiting isn’t a sign something’s wrong, it’s built into the shape of hope itself.", reflection: "Can you hold your current waiting as a sign of hope rather than a sign of delay or failure?" },
    ],
  },
];
